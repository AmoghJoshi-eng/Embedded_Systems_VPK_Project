...
//const int num = 3;
#define num 3 //macro for number of sensors 
// const char* sensorNames[num] = {"Vata", "Pitta", "Kapha"};
//const byte SIZE = 4;
#define SIZE 4 // macro for Size
byte rates[num][SIZE];
byte rSpot[num] = {0,  0};//array for rate spot index
long lBeat[num] = {0, 0}; // array for lastbeat
float bpm[num]; 
...
void loop()
{
  /*for (int i = 0; i < num; i++) {
    ...
    Serial.print(sense_arr[i].getIR());
    Serial.print(',');
    Serial.print("delay of sensor:");
    Serial.println(millis());
    Serial.print(',');
  }*/
  Serial.print("Start getting readings: ");
  Serial.println(millis());
  Wire_2.beginTransmission(I2CMux);// transmission begin 
    Wire_2.write(1 << 0);
    Wire_2.endTransmission();
    float data1 = sense_arr[0].getIR();
    ...
    Wire_2.write(1 << 2);
    Wire_2.endTransmission();
    float data3 = sense_arr[2].getIR();
    Serial.print("sensor 3 reading:");
    Serial.print(data3);
    Serial.print(',');
    Serial.print("delay of sensor 3:");
    Serial.println(millis());
